...
javascript:Models.user.changeAvatar(prompt("halloween01"));
javascript:Models.user.changeAvatar(prompt("halloween02"));
javascript:Models.user.changeAvatar(prompt("halloween03"));
javascript:Models.user.changeAvatar(prompt("halloween04"));
javascript:Models.user.changeAvatar(prompt("halloween05"));
javascript:Models.user.changeAvatar(prompt("halloween06"));
javascript:Models.user.changeAvatar(prompt("halloween07"));
javascript:Models.user.changeAvatar(prompt("halloween08"));
javascript:Models.user.changeAvatar(prompt("halloween09"));
javascript:Models.user.changeAvatar(prompt("halloween10"));
javascript:Models.user.changeAvatar(prompt("halloween11"));
javascript:Models.user.changeAvatar(prompt("halloween12"));
javascript:Models.user.changeAvatar(prompt("halloween13"));
